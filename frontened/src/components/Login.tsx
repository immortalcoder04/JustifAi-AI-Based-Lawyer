...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 auth-background transition-all duration-300">
      <button
        onClick={toggleTheme}
        className="fixed top-4 right-4 p-3 rounded-full bg-white/80 dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-700 shadow-lg backdrop-blur-sm transition-all duration-200 transform hover:scale-105 z-50"
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link to="/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 transition-colors duration-200">
